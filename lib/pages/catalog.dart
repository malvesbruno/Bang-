...
class _CatalogState extends State<Catalog> {
  ...
  _pageCurlController = PageCurlController(
    _pageSize,
    pageCurlIndex: 0,
    numberOfPage: AppData.avatares.length,
  );
  }
      ...
      body: SafeArea(
        child: PageCurlEffect(
          ...
          pageBuilder: (context, index) {
            final item = AppData.avatares[index];
            return Container(
              ...
              child: Column(
                ...
                item.avatarPath == AppData.currentAvatar ? 
                SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    setState(() {
    AppData.currentAvatar = item.avatarPath;
  });
  AppData.salvartudo();
                  },
                  style: ElevatedButton.styleFrom(
                ...
                child: ElevatedButton(
                  onPressed: () async{
                    ...
                    AppData.avataresComprados.add(item.avatarPath);
                    item.owned = true;
                  });
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (builder) => ComprarAvatarpage(avatar: item.avatarPath, name: item.name,)));
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF544528),
                    foregroundColor: Colors.white,
